...
for row, bench in enumerate(BENCHMARK_ORDER):
    for col, (mid, mlabel) in enumerate(MODEL_ORDER):
        ...
        # Modal coverage annotation
        cov = d.get("modal_coverage", d.get("modal_f1_macro", float("nan")))
...
fig.suptitle(
    "Modal [[□p]] Truth-Value Distributions  "
    "(N=250, n=3 situation variants, \u27e8min u\u1d62, max v\u1d62\u27e9)\n"
