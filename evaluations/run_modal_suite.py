...
DATASETS = {
    "truthfulqa": "standard_datasets/truthfulqa_complete.json",
    "simpleqa":   "standard_datasets/simpleqa_complete.json",
    "mmlu-pro":   "standard_datasets/mmlupro_complete.json",
    "factscore":  "standard_datasets/factscore_complete.json",
}
...
def run_pregeneration(benchmark: str, dataset: str, n_variants: int, samples: int,
    ...
    cmd = [
        sys.executable, str(BASE / "pregenerate_variants.py"),
        "--dataset", dataset,
...
def run_modal_evaluation(
    ...
    cmd = [
        sys.executable, str(BASE / "modal_evaluator.py"),
        "--model", model_id,
        "--dataset", dataset,
        "--n-variants", str(n_variants),
        "--samples", str(samples),
